...
| personal 个人相关度 | 40 | LLM 依据个人画像语义判断（异常回退 50；2026-07-29 并入 recency 的 10，2026-07-30 再并入 method 的 10） |
| lab 实验室方向 | 20 | lab_topics 命中 0/1/2/3/≥4 个 → 0/25/50/75/100（批 13 梯度化，防大词表下 ≥2 即饱和） |
| method 方法相关度 | 0 | 个人 methods 命中 0/1/≥2 个 → 0/50/100（权重归零让位 personal，维度仍计算，调回即可恢复） |
