...
def main() -> int:
    ...
    from database.db import connect, get_unprocessed_feedback
    ...
    try:
        ...
        pending = {u["email"]: get_unprocessed_feedback(conn, u["email"]) for _, u in users}
